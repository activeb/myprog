...
;(function($, window, document, undefined) {
	...
	Owl2.prototype.onDragStart = function(event) {
		...
		$(document).on('mousemove.owl2.dragEvents mouseup.owl2.dragEvents touchmove.owl2.dragEvents touchend.owl2.dragEvents', $.proxy(function(event) {this.eventsRouter(event)},this));
	};
	...
	Owl2.prototype.addTriggerableEvents = function() {
		...
		$.each({
			...
			this.$element.on(event + '.owl2.carousel', handler(callback, event + '.owl2.carousel'));
		}, this));
	...
	Owl2.prototype.destroy = function() {
		...
		if (this.settings.responsive !== false) {
			$(window).off('resize.owl2.carousel');
		}
		...
		// remove event handlers in the ".owl2.carousel" namespace
		this.$element.off('.owl2');

		this.$stage.children('.cloned').remove();
		this.e = null;
		this.$element.removeData('owl2Carousel');
	 ...
	 * @param {String} [namespace=.owl2.carousel] - The event namespace.
	 ...
	 * @public
	 */
	$.fn.owl2Carousel = function(options) {
		return this.each(function() {
			if (!$(this).data('owl2Carousel')) {
				$(this).data('owl2Carousel', new Owl2(this, options));
			}
		});
	};
...
;(function($, window, document, undefined) {
	...
	var Lazy = function(carousel) {
		 ...
		 */
		this._handlers = {
			'initialized.owl2.carousel change.owl2.carousel': $.proxy(function(e) {
				if (!e.namespace) {
					return;
				}
...
;(function($, window, document, undefined) {
	...
	var AutoHeight = function(carousel) {
		 ...
		 */
		this._handlers = {
			'initialized.owl2.carousel': $.proxy(function() {
...
;(function($, window, document, undefined) {
	...
	var Video = function(carousel) {
		...
		this._handlers = {
			...
			'refresh.owl2.carousel changed.owl2.carousel': $.proxy(function(e) {
				if (this._playing) {
					this.stop();
				}
			}, this),
...
;(function($, window, document, undefined) {
	...
	var Autoplay = function(scope) {
		...
		this.handlers = {
			'translated.owl2.carousel refreshed.owl2.carousel': $.proxy(function() {
				this.autoplay();
			}, this),
			'play.owl2.autoplay': $.proxy(function(e, t, s) {
				this.play(t, s);
			}, this),
			'stop.owl2.autoplay': $.proxy(function() {
				this.stop();
			}, this),
...
;(function($, window, document, undefined) {
	...
	var Navigation = function(carousel) {
		...
		this._handlers = {
			...
			'add.owl2.carousel': $.proxy(function(e) {
				if (this._core.settings.dotsData) {
					this._templates.splice(e.position, 0, $(e.content).find('[data-dot]').andSelf('[data-dot]').attr('data-dot'));
				}
			}, this),
			'remove.owl2.carousel prepared.owl2.carousel': $.proxy(function(e) {
				if (this._core.settings.dotsData) {
			...
			'refreshed.owl2.carousel': $.proxy(function() {
...
;(function($, window, document, undefined) {
	...
	var Hash = function(carousel) {
		...
		$(window).on('hashchange.owl2.navigation', $.proxy(function() {
